...
function generate_new_transaction_number() {
	...
	$staff_email = 'gamier.lester.test@gmail.com';
	$customer_email = $_SESSION['user']['email'];          //
	$subject = 'PShopping - Order Confirmation';
    ...
    //make sure to input correct path
        ->setReturnUrl('https://pshopping.herokuapp.com/app/controllers/pay.php?success=true')
        ->setCancelUrl('https://pshopping.herokuapp.com/app/controllers/pay.php?success=false');
        //===========================================
